...
data = dict(
    ...
    train=dict(
        ...
        dataset_info={{_base_.dataset_info}}),
    val=coco_val,
    test=coco_val # change to coco_test for test-dev evalutation
)
